...
#### マイク音声翻訳の音声
マイク音声翻訳のマイク音声入力と読み上げ音声出力のオーディオデバイスは、**オプション → Audio input/output**で選択できます。一時的に翻訳を止めたい場合や、騒がしい環境で余計な声も翻訳されてしまう場合は、マイクオフボタンでいつでもマイク入力をオフにできます。
...
3. **オプション → Audio output** で仮想オーディオデバイスを選ぶ。マイク音声翻訳の読み上げがこのデバイスに送られます（タブ音声翻訳の読み上げはヘッドホンに届きます）。

...
export const DEFAULTS = {
  ...
  // drops the translated audio before it is played — and only what would reach
  // the speakers: a microphone direction sent to a device of its own by
  // `micOutput` is feeding something that is not the user, and this button is
  // about what the user hears.
  micMuted: false,
  soundMuted: false,
